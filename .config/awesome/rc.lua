...
-- {{{ Tags
tags = {
   names  = { "1:main",   "2:web/mail",    "3:term",   "4:files",  "5:media",  "6:doc",    "7:dev",    "8:vbox", "9:other" },
   layout = { layouts[2], layouts[2], layouts[6], layouts[4], layouts[1], layouts[2], layouts[2], layouts[10], layouts[1] }
}
