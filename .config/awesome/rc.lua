...
modkey     = "Mod1"
altkey     = "Mod4"
terminal   = "terminator" or "urxvtc" or "xterm"
...
mytextclock = awful.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#535f7a", ">") .. markup("#de5e1e", " %H:%M "))
--[[
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1:main", "2:web/mail", "3:term", "4:files", "5:media", "6:doc", "7:dev", "8:vbox", "9:misc" }, s, {
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey,           }, "h",      function () fsroot.show(7, "--exclude-type=tmpfs") end),
    ...
    -- Program lauchers
    awful.key({ altkey }, "f", function () awful.spawn("firefox")            end),
    awful.key({ altkey }, "t", function () awful.spawn("icedove")            end),
    awful.key({ altkey }, "b", function () awful.spawn("evolution")          end),
    awful.key({ altkey }, "v", function () awful.spawn("gvim")               end),
    awful.key({ altkey }, "s", function () awful.spawn("spotify")            end),
    awful.key({ altkey }, "e", function () awful.spawn("thunar")             end),
    awful.key({ altkey }, "g", function () awful.spawn("google-chrome")      end),
    awful.key({ altkey }, "d", function () awful.spawn("chromium")           end),
    awful.key({ altkey }, "l", function () awful.spawn("xautolock -locknow") end),
    -- Dmenu
